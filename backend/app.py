...
from schemas import GetGame, WagerCreate, GameSetBank


app = FastAPI(
    title='easy blackjack'
)
...
def get_card():
    ...
    game['status'] = 'goes on' if user_cards['total cost'] < 21 else 'user completed'
